...
const LoginForm = () => {
  usePageTitle('چوونە ژوورەوە');
  const [showPassword, setShowPassword] = useState(false);
  const navigate = useNavigate();

  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6 font-nrt">
      <div className="relative bg-white rounded-[2rem] shadow-2xl w-full max-w-md p-8 md:p-10 border border-slate-100">
        ...
        <div className="text-center mb-10">
          <h2 className="text-3xl font-bold text-slate-900">بەخێربێیتەوە</h2>
        </div>
        ...
        <form className="space-y-6">
          ...
          <div className="text-center mt-8">
            <p className="text-slate-500 font-medium">
              ...
              <Link to="/registerK" className='text-blue-500 font-bold hover:text-blue-600 hover:underline'>  
                خۆ تۆمارکردن   
              </Link>
            </p>
          </div>
