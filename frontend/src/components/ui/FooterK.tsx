          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-8 md:gap-0">
              ...
              <div className="flex items-center gap-2.5">
                  <div className="h-17 w-20 bg-white/20 rounded flex items-center justify-center font-bold">Wasta</div>
              </div>
    
              {/* 2. Navigation Links */}
              <nav className="flex flex-wrap justify-center gap-8 md:gap-12 text-sm font-medium text-slate-300">
                <Link to="/K" className="hover:text-white transition-colors">سەرەکی</Link>
                <Link to="/workerK" className="hover:text-white transition-colors">وەستاکان</Link>
                <Link to="/categoryK" className="hover:text-white transition-colors">بەشەکان</Link>
